...
la_df <- tibble(
  ...
  Topic  = c(
    ...
    build_link("Inverse and Identity",
               "linear-algebra/#inverse-and-identity"),
    build_link("Transpose",
               "linear-algebra/#transpose")
    ),
  r_icon = c(
    build_link("<strong>R</strong>", "linear-algebra/#r"),
    build_link("<strong>R</strong>", "linear-algebra/#r-1"),
    build_link("<strong>R</strong>", "linear-algebra/#r-2"),
    build_link("<strong>R</strong>", "linear-algebra/#r-3"),
    build_link("<strong>R</strong>", "linear-algebra/#r-4"),
    build_link("<strong>R</strong>", "linear-algebra/#r-5"),
    build_link("<strong>R</strong>", "linear-algebra/#r-6")
    ),
  rcpp = list(
    "",
    # str_flatten(
    ...
    str_flatten(
      c(build_link("<strong>Rcpp</strong>", "linear-algebra/#rcpp-5"),
        build_link("RcppAmardillo", "linear-algebra/#rcpparmadillo-5")),
      collapse = collapser
      )
    ),
  py = c(
    ...
    str_flatten(
      c(build_link("<strong>Python</strong>", "linear-algebra/#python-6"),
        build_link("NumPy", "linear-algebra/#numpy-6")),
      collapse = collapser
      )
    )
  ) %>% 
