...
la_df <- tibble(
  Topic  = c(
    ...
    build_link("Scalar Multiplication",
               "linear-algebra/#matrix-scalar-multiplication"),
  ...
  r_icon = c(
    build_link("<strong>R</strong>", "linear-algebra/"),
    build_link("<strong>R</strong>", "linear-algebra/"),
    build_link("<strong>R</strong>", "linear-algebra/"),
    build_link("<strong>R</strong>", "linear-algebra/"),
    build_link("<strong>R</strong>", "linear-algebra/"),
  ...
  rcpp = list(
    str_flatten(
      c(build_link("<strong>Rcpp</strong>", "linear-algebra/"),
        build_link("Built-in", "linear-algebra/"),
  ...
  py = c(
    str_flatten(
      c(build_link("<strong>Python</strong>", "linear-algebra/"),
        build_link("NumPy", "linear-algebra/"),
        build_link("CuPy", "linear-algebra/")),
      collapse = collapser
      ),
    str_flatten(
      c(build_link("<strong>Python</strong>", "linear-algebra/"),
