...
as_chunk("describing-data/cpp-length-size.cpp")
...
embed_github_link("describing-data/cpp-length-size.cpp")
```
...
```{bash, echo=FALSE}
cd /mnt/c/Users/Windows/Documents/tutorial-gists/sections/describing-data &&
  g++ -std=c++17 cpp-length-size.cpp -o cpp-length-size &&
  ./cpp-length-size
```
...
as_chunk("describing-data/cpp-min-max.cpp")
...
embed_github_link("describing-data/cpp-min-max.cpp")
```
...
as_chunk("describing-data/cpp-sum.cpp")
...
embed_github_link("describing-data/cpp-sum.cpp")
```
